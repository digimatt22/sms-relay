...
export default function ChangePasswordForm({ platformName }: { platformName: string }) {
    ...
    <section className="panel login">
      <div className="page-header">
        <div>
          ...
          <p>Your temporary password must be changed before you can use {platformName}.</p>
        </div>
      </div>
